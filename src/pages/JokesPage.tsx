...
export default function JokesPage() {
    ...
    const [activePage, setActivePage] = useState<'posts' | 'memories' | 'jokes'>('jokes');
    ...
    const fetchJokes = async () => {
        ...
        try {
            ...
            console.error('Erro ao buscar piadas:', err);
            setPosts([]);
        } finally {
    ...
    if (authLoading || loadingPosts) return <p className="loading">Carregando piadas...</p>;
                ...
                <main className="feed">
                    ...
                    {isAdmin && (
                        <div className="create-post">
                            <Link to="/create-post">Criar Nova Piada</Link>
                        </div>
                    )}
                    ...
                    <section className="post-grid" aria-live="polite">
                        {posts.length > 0 ? (
                            ...
                            <div className="no-posts">
                                ...
                                <p>Que tal compartilhar a primeira piada e fazer todo mundo rir?</p>
                                {isAdmin && (
                                    <Link to="/create-post" className="create-first-post">
                                        Criar Primeira Piada
                                    </Link>
                                )}
                            </div>
                        )}
